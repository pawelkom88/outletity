...
export default function CloseBtn({toggle}) {
  return (
    <button onClick={toggle} alt="close button" className="close-btn">
      <svg fill="#333" width="20px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
